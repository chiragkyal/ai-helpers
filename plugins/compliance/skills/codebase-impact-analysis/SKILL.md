...
This skill is called from Phase 2 of the `analyze-cve` skill, after the [Repo Guard](../analyze-cve/reference/implementation.md#repo-guard--re-clone-if-missing) has confirmed `REPO_DIR` still exists.
