...
Called from **Phase 6** of the [analyze-cve](../analyze-cve/SKILL.md) skill after Phase 5 verification succeeds. Runs after the [Repo Guard](../analyze-cve/reference/implementation.md#repo-guard--re-clone-if-missing) has confirmed `REPO_DIR` still exists.
